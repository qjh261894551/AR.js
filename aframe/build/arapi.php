...
function saveStuffImgInfo($data,$location,$title,$url,$grayData)//$data数组由16个数字构成，$location为GPS经纬度，
	{
...
function getSimilarImgInfo($data,$location,$grayData)//$data由16个数字构成，$location为GPS经纬度，$grayData灰度相关值
	{
		...
		//var_dump($data[0]);
		 ...
		 $desition .=" and abs(redRate1-".$data[0].")<0.12 and abs(greenRate1-".$data[1].")<0.12 and abs(rgbRate1-".$data[3].")<0.12 and abs(redRate2-".$data[4].")<0.12 and abs(greenRate2-".$data[5].")<0.12 and abs(blueRate2-".$data[6].")<0.12  and abs(rgbRate2-".$data[7].")<0.12 and abs(redRate3-".$data[8].")<0.12  and abs(greenRate3-".$data[9].")<0.12 and abs(blueRate3-".$data[10].")<0.12 and abs(rgbRate3-".$data[11].")<0.12 and abs(redRate-".$data[12].")<0.12 and abs(greenRate-".$data[13].")<0.12 and abs(blueRate-".$data[14].")<0.12 and abs(rgbRate-".$data[15].")<0.12";
